    ...
    <div style={styles.page}>
      <div style={styles.terminal}>
        ...
        <div style={styles.titleBar}>
          ...
          <span style={styles.titleText}>control-plane — auth</span>
        </div>
        <div style={styles.body}>
          <div style={styles.header}>
            <span style={styles.prompt}>&gt;</span> AUTHENTICATE
          </div>
          <div style={styles.subtitle}>// Access the control plane admin interface</div>
